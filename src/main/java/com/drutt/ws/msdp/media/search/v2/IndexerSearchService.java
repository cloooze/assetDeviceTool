 ...
 * 
 */
@WebServiceClient(name = "IndexerSearchService", targetNamespace = "http://ws.drutt.com/msdp/media/search/v2", wsdlLocation = "file:/C:/Users/ebragan/git/sprintsc-repo/eai-sync/src/main/resources/search-v2.1.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/C:/Users/ebragan/git/sprintsc-repo/eai-sync/src/main/resources/search-v2.1.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/Users/ebragan/git/sprintsc-repo/eai-sync/src/main/resources/search-v2.1.wsdl', retrying as a local file");
